...
bool KU_User::getDeleteHome()
{
  return isDeleteHome;
}

bool KU_User::getDeleteMailBox()
{
  return isDeleteMailBox;
}

bool KU_User::getCreateHome()
{
  return isCreateHome;
}

bool KU_User::getCreateMailBox()
{
  return isCreateMailBox;
}

bool KU_User::getCopySkel()
{
  return isCopySkel;
}

const QString &KU_User::getName() const
{
  return p_name;
}

const QString &KU_User::getSurname() const
{
  return p_surname;
}

const QString &KU_User::getEmail() const
{
  return p_email;
}

const QString &KU_User::getPwd() const
{
  return p_pwd;
}

const QString &KU_User::getHomeDir() const
{
  return p_dir;
}

const QString &KU_User::getShell() const
{
  return p_shell;
}

const QString &KU_User::getFullName() const
{
  return p_fname;
}

bool KU_User::getDisabled() const
{
  return isDisabled;
}
...
const QString &KU_User::getOffice() const
{
  return p_office;
}

const QString &KU_User::getWorkPhone() const
{
  return p_ophone;
}

const QString &KU_User::getHomePhone() const
{
  return p_hphone;
}

// New fields needed for the FreeBSD /etc/master.passwd file
const QString &KU_User::getClass() const
{
  return p_class;
}

const QString &KU_User::getOffice1() const
{
  return p_office1;
}

const QString &KU_User::getOffice2() const
{
  return p_office2;
}

const QString &KU_User::getAddress() const
{
  return p_address;
}

uid_t KU_User::getUID() const
{
  return p_uid;
}

gid_t KU_User::getGID() const
{
  return p_gid;
}

const QString &KU_User::getSPwd() const
{
  return s_pwd;
}

time_t KU_User::getLastChange() const
{
  return p_change;
}

int KU_User::getMin() const
{
  return s_min;
}

int KU_User::getMax() const
{
  return s_max;
}

int KU_User::getWarn() const
{
  return s_warn;
}

int KU_User::getInactive() const
{
  return s_inact;
}

int KU_User::getFlag() const
{
  return s_flag;
}

time_t KU_User::getExpire() const
{
  return p_expire;
}

const QString &KU_User::getLMPwd() const //  sam_lmpwd,
{
  return sam_lmpwd;
}

const QString &KU_User::getNTPwd() const //sam_ntpwd,
{
  return sam_ntpwd;
}

const QString &KU_User::getLoginScript() const //sam_loginscript,
{
  return sam_loginscript;
}

const QString &KU_User::getProfilePath() const //  sam_profile,
{
  return sam_profile;
}

const QString &KU_User::getHomeDrive() const //sam_homedrive,
{
  return sam_homedrive;
}

const QString &KU_User::getHomePath() const //sam_homepath;
{
  return sam_homepath;
}

const QString &KU_User::getWorkstations() const //sam_workstation;
{
  return sam_workstations;
}

const QString &KU_User::getDomain() const //sam_domain;
{
  return sam_domain;
}

const SID &KU_User::getSID() const //sid,
{
  return sid;
}

const SID &KU_User::getPGSID() const //pgroup_sid;
{
  return pgroup_sid;
}

void KU_User::setName(const QString &data)
{
  p_name = data;
}

void KU_User::setSurname(const QString &data)
{
  p_surname = data;
}

void KU_User::setEmail(const QString &data)
{
  p_email = data;
}

void KU_User::setPwd(const QString &data)
{
  p_pwd = data;
}

void KU_User::setHomeDir(const QString &data)
{
  p_dir = data;
}

void KU_User::setShell(const QString &data)
{
  p_shell = data;
}

void KU_User::setFullName(const QString &data)
{
  p_fname = data;
}

void KU_User::setDisabled(bool data)
{
  isDisabled = data;
}
...
// FreeBSD apparently uses the GECOS fields differently than other Unices.
// Create some better named functions to make the FreeBSD code clear
void KU_User::setOffice(const QString &data)
{
  p_office = data;
}

void KU_User::setWorkPhone(const QString &data)
{
  p_ophone = data;
}

void KU_User::setHomePhone(const QString &data)
{
  p_hphone = data;
}

// New fields needed for the FreeBSD /etc/master.passwd file
void KU_User::setClass(const QString &data)
{
  p_class = data;
}

void KU_User::setLastChange(time_t data)
{
  p_change = data;
}

void KU_User::setExpire(time_t data)
{
  p_expire = data;
}

void KU_User::setOffice1(const QString &data)
{
  p_office1 = data;
}

void KU_User::setOffice2(const QString &data)
{
  p_office2 = data;
}

void KU_User::setAddress(const QString &data)
{
  p_address = data;
}

void KU_User::setUID(uid_t data)
{
  p_uid = data;
}

void KU_User::setGID(gid_t data)
{
  p_gid = data;
}

void KU_User::setSPwd(const QString &data)
{
  s_pwd = data;
}

void KU_User::setMin(int data)
{
  s_min = data;
}

void KU_User::setMax(int data)
{
  s_max = data;
}

void KU_User::setWarn(int data)
{
  s_warn = data;
}

void KU_User::setInactive(int data)
{
  s_inact = data;
}

void KU_User::setLMPwd( const QString &data ) //  sam_lmpwd,
{
  sam_lmpwd = data;
}

void KU_User::setNTPwd( const QString &data ) //sam_ntpwd,
{
  sam_ntpwd = data;
}

void KU_User::setLoginScript( const QString &data ) //sam_loginscript,
{
  sam_loginscript = data;
}

void KU_User::setProfilePath( const QString &data) //  sam_profile,
{
  sam_profile = data;
}

void KU_User::setHomeDrive( const QString &data ) //sam_homedrive,
{
  sam_homedrive = data;
}

void KU_User::setHomePath( const QString &data ) //sam_homepath;
{
  sam_homepath = data;
}

void KU_User::setWorkstations( const QString &data ) //sam_workstation;
{
  sam_workstations = data;
}

void KU_User::setDomain( const QString &data ) //sam_domain
{
  sam_domain = data;
}

void KU_User::setSID( const SID &data ) //sid,
{
  sid = data;
}

void KU_User::setPGSID( const SID &data ) //pgroup_sid;
{
  pgroup_sid = data;
}

void KU_User::setFlag(int data)
{
  s_flag = data;
}

void KU_User::setCreateHome(bool data)
{
  isCreateHome = data;
}

void KU_User::setCreateMailBox(bool data)
{
  isCreateMailBox = data;
}

void KU_User::setCopySkel(bool data)
{
  isCopySkel = data;
}

void KU_User::setDeleteHome(bool data)
{
  isDeleteHome = data;
}

void KU_User::setDeleteMailBox(bool data)
{
...
void KU_User::copyDir(const QString &srcPath, const QString &dstPath)
{
  mode_t mode;
  QDir s(srcPath);
  QDir d(dstPath);
...
int KU_User::removeHome()
{
  ...
  if (!stat(QFile::encodeName(p_dir), &sb))
    if (S_ISDIR(sb.st_mode) && sb.st_uid == p_uid) {
      if (!KIO::NetAccess::del(KURL::fromPathOrURL(p_dir),0L)) {
...
KU_User *KU_Users::lookup(const QString & name)
{
  KU_User *user;
...
KU_User *KU_Users::lookup(uid_t uid)
{
  KU_User *user;
  Q3PtrListIterator<KU_User> it( mUsers );
...
KU_User *KU_Users::lookup_sam( const SID &sid )
{
  KU_User *user;
  Q3PtrListIterator<KU_User> it( mUsers );
...
KU_User *KU_Users::lookup_sam( const QString &sid )
{
  KU_User *user;
  Q3PtrListIterator<KU_User> it( mUsers );
...
KU_User *KU_Users::lookup_sam( uint rid )
{
  KU_User *user;
  Q3PtrListIterator<KU_User> it( mUsers );
...
uint KU_Users::count() const
{
  return mUsers.count();
}

KU_User *KU_Users::operator[](uint num)
{
  return mUsers.at(num);
}

KU_User *KU_Users::first()
{
  return mUsers.first();
}

KU_User *KU_Users::next()
{
  return mUsers.next();
}

void KU_Users::add(KU_User *user)
{
  mAdd.append( user );
}

void KU_Users::del(KU_User *user)
{
  mDel.append( user );
}

void KU_Users::mod(KU_User *uold, const KU_User &unew)
{
